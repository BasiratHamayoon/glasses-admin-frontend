...
export default function InventoryPage() {
  ...
  useEffect(() => {
    ...
    pageRef.current = 1;
    runAdjFetch(1, adjFilters);
  }, [adjFilters.status, adjFilters.adjustmentType]);
  ...
  useEffect(() => {
    ...
    pageRef.current = 1;
    runTransferFetch(1, transferFilters);
  }, [transferFilters.status, transferFilters.transferType]);
