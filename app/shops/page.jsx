...
export default function ShopsPage() {
  ...
  const runFetch = useCallback((page, filters, force = true) => {
    dispatch(fetchShops({ ...filters, page, limit: ITEMS_PER_PAGE, force }));
  }, [dispatch]);
  ...
  useEffect(() => {
    ...
    runFetch(1, initialFilters, false);
  ...
  useEffect(() => {
    ...
    pageRef.current = 1;
    runFetch(1, shopFilters);
  }, [shopFilters.status, shopFilters.shopType]);
