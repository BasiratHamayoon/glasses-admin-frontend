  ...
  return (
    ...
    >
      <MultiSelect
        ...
        onChange={(val) =>
          handleChange("shopId", val.length > 0 ? val[val.length - 1] : "")
        }
      />
      ...
      <MultiSelect
        ...
        onChange={(val) =>
          handleChange("category", val.length > 0 ? val[val.length - 1] : "")
        }
      />
      ...
      <input
        ...
        className="flex min-h-[36px] w-full bg-white dark:bg-[#111111] border border-neutral-200 dark:border-neutral-800 rounded-sm py-1.5 px-3 text-[10px] outline-none shadow-sm"
      />
      <input
        type="date"
